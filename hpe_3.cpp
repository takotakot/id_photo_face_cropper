...
/*
    ...
    */
    ...
    const static cv::Point3f P3D_MOUTH_LEFT(-32.14, 27.9, -116.76);
    const static cv::Point3f P3D_MOUTH_RIGHT(-32.14, -27.9, -116.76);

    const static cv::Point3f P3D_HEAD_TOP(-100., 0, 115.14);
    const static cv::Point3f P3D_HEAD_BACK(-70.7, 0, 115.14);
